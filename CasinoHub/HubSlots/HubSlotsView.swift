...
struct HubSlotsView: View {
    ...
    var arrayGames = [Games(name: "Classic Fruits",
                      ...
                      Games(name: "Egypt Paradise",
                            imageName: "slot5",
                            desc: "Shooting stars and cosmic wins",
                            min: "30",
                            maxwin: "3 000",
                            gradient: LinearGradient(colors: [Color(red: 240/255, green: 128/255, blue: 0/255),
                                                              Color(red: 253/255, green: 182/255, blue: 2/255),
                                                              Color(red: 240/255, green: 128/255, blue: 0/255)], startPoint: .topLeading, endPoint: .bottomTrailing)),
                      Games(name: "Aqua Deluxe",
                            imageName: "slot6",
